...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=config["ACCESS_TOKEN_LIFETIME"]),  # expiry time of the access token
    'REFRESH_TOKEN_LIFETIME': timedelta(days=config["REFRESH_TOKEN_LIFETIME"]),  # expiry time of the refresh token
...
# Iterate over the database configurations in config.json
