...
(1,21,1,'Breakfast','2023-11-02',1,1,'2023-11-02 21:18:15',NULL,NULL),
...
(1,'Heart','Chicken','High Blood',1,'2023-11-02 19:41:47',1,NULL,NULL);
...
(1,1,1,83,1,'2023-08-23 20:24:47',1,'2023-11-02 10:58:53',1),
...
CREATE TABLE `T_Restrictions` (
  ...
  `ReferenceRestrictionID` bigint(20) NOT NULL,
  `DateAdded` datetime NOT NULL DEFAULT current_timestamp(),
  `AddedByUserLoginID` bigint(20) NOT NULL,
  `DateUpdated` datetime DEFAULT NULL,
  `UpdatedByUserLoginID` bigint(20) DEFAULT NULL,
...
(1,22,1,1,'none',9,'2023-11-02 19:52:00',1,NULL,NULL),
		...
		WHEN 1 THEN 
			 BEGIN
				...
				*/
				...
				SET $_MealPlanDate := TRIM(JSON_UNQUOTE(JSON_EXTRACT($JSON,"$.MealDate")));	
